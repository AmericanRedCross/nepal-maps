...
function getMeta() {
  d3.csv("data/admin-atlas.csv", function(metadata){
...
function generateThumbnails(metadata){
  ...
  function generateThumbnailHtml(item){
    var s3 = 'https://s3-us-west-2.amazonaws.com/arcmaps/nepal/admin/'+item.filename;
    var linkHtml = '';
    ...
    var itemHtml = '<div onclick="callModal(this);" class="thumbnail">'+
        '<img class="lazy" data-original="img/'+item.filename.slice(0,-4)+'_thumb.jpg'+'" width="142" height="200">'+
        '<div class="caption">'+
        ...
        '<div class="modalDescription" style="display:none;">'+
            '<h4 style="font-weight:bold;">'+item.title+
  ...
  thumbnails = d3.select("#mappreviews").selectAll('div')
    ...
    .classed('thumbnailWrap col-xs-3', true)
